...
parser.add_argument('-i', metavar='INPUT', default='.',
                    help='Scan output file or folder (default current folder)')
parser.add_argument('-p', metavar='PREFIX', default='nmap2csv',
                    help='prefix for output file names (default nmap2csv)')
parser.add_argument('-s', metavar='SUFFIX', default='tcp',
                    help='suffix for output file names (default tcp)')
parser.add_argument('-m', metavar='MARKER', default='X',
                    help='marker character (default X)')
